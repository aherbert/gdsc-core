...
public enum FloatDistanceFunctions implements FloatDistanceFunction {
  ...
  SQUARED_EUCLIDEAN_ND {
    @Override
    public double distance(double[] p1, float[] p2) {
      double distance = 0;
    ...
    @Override
    public double distanceToRectangle(double[] point, float[] min, float[] max) {
      double distance = 0;
   ...
   */
  public static FloatDistanceFunction squaredEuclidean(int dimensions) {
    if (dimensions == 2) {
