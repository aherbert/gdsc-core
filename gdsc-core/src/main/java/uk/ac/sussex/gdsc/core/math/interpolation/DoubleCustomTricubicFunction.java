...
public class DoubleCustomTricubicFunction extends CustomTricubicFunction {
   ...
   */
  DoubleCustomTricubicFunction(DoubleCubicSplineData coefficients) {
  ...
  public CustomTricubicFunction toSinglePrecision() {
    ...
    getCoefficients(tmp);
    return new FloatCustomTricubicFunction(new FloatCubicSplineData(tmp));
  }
