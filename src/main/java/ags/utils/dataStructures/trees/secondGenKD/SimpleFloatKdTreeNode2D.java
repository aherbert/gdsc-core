 ...
 * <p>
 * This is a basic copy of the KdTree class but limited to 2 dimensions and has no ability to store object data.
 * 
 * @author Alex Herbert
 */
abstract class SimpleFloatKdTreeNode2D
{
	 ...
	 */
	SimpleFloatKdTreeNode2D(SimpleFloatKdTreeNode2D parent, boolean right)
	{
		// Init as leaf
