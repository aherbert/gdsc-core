...
public class FilteredNonMaximumSuppression extends NonMaximumSuppression {
  ...
  /**
   * Compute the local-maxima within a 2n+1 block <p> Any maxima below the configured fraction above
   * background are ignored. Fraction = (Max-background)/Max within the 2n+1 neighbourhood. Maxima
   * below the minimum height (above background) or the minimum peak-width at half maximum in any
   ...
   * maxima. <p> Any maxima below the configured fraction above background are ignored. Fraction =
  ...
  /**
   * Compute the local-maxima within a 2n+1 block. <p> Any maxima below the configured fraction
   * above background are ignored. Fraction = (Max-background)/Max within the 2n+1 neighbourhood.
   * Maxima below the minimum height (above background) or the minimum peak-width at half maximum in
   * any dimension are ignored. <p> Uses the 2D block algorithm of Neubeck and Van Gool (2006).
   *
   * @param data The input data (packed in YX order)
   * @param maxx The width of the data
   * @param maxy The height of the data
   ...
   * maxima. <p> Any maxima below the configured fraction above background are ignored. Fraction =
   * (Max-background)/Max within the 2n+1 neighbourhood. Maxima below the minimum height (above
   * background) or the minimum peak-width at half maximum in any dimension are ignored. <p> Uses
   * the 2D block algorithm of Neubeck and Van Gool (2006).
   *
   * @param data The input data (packed in YX order)
   * @param maxx The width of the data
   * @param maxy The height of the data
  ...
  /**
   * Compute the local-maxima within a 3x3 block <p> Any maxima below the configured fraction above
   * background are ignored. Fraction = (Max-background)/Max within the 3x3 neighbourhood. Maxima
   * below the minimum height (above background) or the minimum peak-width at half maximum in any
   * dimension are ignored. <p> Note: The height thresholding step is ignored if the height
   * threshold is zero.
   *
   * @param data The input data (packed in YX order)
   * @param maxx The width of the data
   ...
   * image is even/odd dimensions). <p> Any maxima below the configured fraction above background
   * are ignored. Fraction = (Max-background)/Max within the 3x3 neighbourhood. Maxima below the
   * minimum height (above background) or the minimum peak-width at half maximum in any dimension
   * are ignored. <p> Note: The height thresholding step is ignored if the height threshold is zero.
   *
   * @param data The input data (packed in YX order)
   * @param maxx The width of the data
   * @param maxy The height of the data
   ...
   * then the local maxima within the block is elminiated. This step is only relevant when neighbour
