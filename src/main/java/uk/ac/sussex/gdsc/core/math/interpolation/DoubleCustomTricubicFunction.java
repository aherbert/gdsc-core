...
public class DoubleCustomTricubicFunction extends CustomTricubicFunction {
   ...
   */
  DoubleCustomTricubicFunction(double[] coefficients) {
   ...
   * @param coefficients List of spline coefficients.
   */
  DoubleCustomTricubicFunction(float[] coefficients) {
    this.coeff = toDouble(coefficients);
  }
  ...
  public CustomTricubicFunction toSinglePrecision() {
    return new FloatCustomTricubicFunction(coeff);
  }
  ...
  public CustomTricubicFunction copy() {
    return new DoubleCustomTricubicFunction(coeff.clone());
  }
