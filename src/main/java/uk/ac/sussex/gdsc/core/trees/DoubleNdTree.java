...
class DoubleNdTree implements DoubleKdTree {
   ...
   */
  private boolean addPoint(double[] location, BiPredicate<DoubleNdTree, double[]> filter) {
   ...
   */
  private static void ascendAndDecrement(DoubleNdTree current) {
  ...
  private void forEach(DoubleNdTree cursor, Consumer<double[]> action) {
