...
/**
 * Contains a set of random numbers that are reused in sequence. The sequence is updated to contain
 * numbers in the interval 0 (inclusive) to 1 (exclusive). This class thus violates the contract of
