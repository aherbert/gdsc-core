 ...
 *
 * <p>This is a basic copy of the KdTree class has no ability to store object data.
 *
 * @author Alex Herbert
 */
abstract class SimpleKdTreeNode {
  /** The bucket size. */
  ...
  /** The left. */
  SimpleKdTreeNode left;
  /** The right. */
  SimpleKdTreeNode right;
  /** The split dimension. */
  int splitDimension;
  /** The split value. */
  double splitValue;
   ...
   */
  SimpleKdTreeNode(int dimensions) {
   ...
   */
  SimpleKdTreeNode(SimpleKdTreeNode parent) {
