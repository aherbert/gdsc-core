 ...
 * dimensions. Functionality to limit the tree size has been removed.
 *
 * @author Alex Herbert
 */
public abstract class SimpleFloatKdTree2D extends SimpleFloatKdTreeNode2D {
  ...
  /**
   * Calculates the nearest 'count' point distances to 'location'. Results are unsorted. The first
   * entry in the returned results in the max distance.
   *
   * @param location the location
   * @param count the count
   * @return the float[]
