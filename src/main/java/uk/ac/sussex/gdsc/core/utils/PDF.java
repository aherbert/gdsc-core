...
/**
 * Provides sampling from a 1D histogram <p> Adapted from The GNU Scientific library
...
public class PDF {
   ...
   *
   * @param data The data
   * @throws IllegalArgumentException if the input data length is not at least 1
