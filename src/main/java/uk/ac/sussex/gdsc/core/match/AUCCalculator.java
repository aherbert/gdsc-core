...
public class AUCCalculator {
  ...
  /**
   * Calculates an estimate of the area under the precision-recall curve. <p> The estimate is
   * computed using integration above the recall limit. Below the limit a simple linear
   * interpolation is used from the given point to precision 1 at recall 0. This avoids noise in the
   * lower recall section of the curve. <p> If no recall values are above the limit then the full
  ...
  /**
   * Calculates an estimate of the area under the precision-recall curve. <p> Assumes the first
   * values in the two arrays are precision 1 at recall 0.
   *
   * @param precision the precision
   * @param recall the recall
   * @return Area under the PR curve
