...
/**
 * Provides classes for constructing and searching a <a
 * href="https://en.wikipedia.org/wiki/K-d_tree">KD-Tree</a>. <p> The code contained here has been
 * taken from <a
 ...
 * contains one of the fastest in the standard benchmark tests. <p> The code is Copyright 2009
 * Rednaxela. <p> Modifications to the code have been made by Alex Herbert for a smaller memory
 * footprint and optimised 2D processing.
 *
