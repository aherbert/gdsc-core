 ...
 * starting from 0 (i.e. the histogram constructed from an unsigned integer set of data, e.g. an
 * 8-bit image)
 */
public class Histogram implements Cloneable {
   ...
   * sub-classes. <p> Compaction is not supported in this class since the histogram is an integer
   * histogram.
   *
   * @param size the size
