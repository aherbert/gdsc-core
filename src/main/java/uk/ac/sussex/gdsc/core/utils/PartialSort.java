...
public class PartialSort {
  /**
   * Sort the final returned data. This takes precedence over {@link #OPTION_HEAD_FIRST}. <p> Note
   * that if the number of points to return (n) is above half the total size of the input list (m,
   * e.g. n/m &gt; 0.5) then it is probably faster to sort the input list and take the top n.
   */
  ...
  /**
   * Provide partial sort of double arrays <p> This class is based on
   * ags.utils.dataStructures.trees.secondGenKD.ResultHeap. Ideas have been taken from:
  ...
  public static class DoubleHeap {
    ...
    /**
     * Pick the bottom N from the data using ascending order, i.e. find the bottom n smallest
     * values. <p> If the input data size is smaller than N then an
     * {@link ArrayIndexOutOfBoundsException} will occur.
     *
    ...
    /**
     * Pick the top N from the data using ascending order, i.e. find the top n largest values. <p>
     * If the input data size is smaller than N then an {@link ArrayIndexOutOfBoundsException} will
     * occur.
     *
     * @param list the data list
  ...
  /**
   * Provide partial sort of float arrays <p> This class is based on
   * ags.utils.dataStructures.trees.secondGenKD.ResultHeap. Ideas have been taken from:
   * http://sites.fas.harvard.edu/~libs111/code/heaps/Heap.java
   */
