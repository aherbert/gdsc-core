 ...
 * 
 * <p>Sort by size, then centroid x, then y, then the total weight. The sort is arbitrary but allows
...
public class ClusterComparator implements Comparator<Cluster>, Serializable {
   ...
   */
  private static final long serialVersionUID = 2762779582190981392L;
   ...
   */
  public static ClusterComparator getDefaultInstance() {
    return INSTANCE;
  }
}
