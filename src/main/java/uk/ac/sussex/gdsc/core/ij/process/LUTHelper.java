...
public class LUTHelper {
  ...
  private static LUT fromRGBValues(byte[] r, byte[] g, byte[] b, int[][] values,
   ...
   * @param greens the greens
   * @param blues the blues
   * @param nColors the number of colours
   ...
   *
   * @param lut the lut
   * @param i The position in the LUT (from 0-255)
   * @return a colour
   */
   ...
   *
   * @param lut the lut
   * @param n The position in the series (zero-based)
  ...
  public static class NullLUTMapper implements LUTMapper {
     ...
     * @param value the value
     * @return the int
     * @see uk.ac.sussex.gdsc.core.ij.process.LUTHelper.LUTMapper#map(float)
     */
    @Override
    public int map(float value) {
      if (value < 0f) {
     ...
     * @param value the value
     * @return the float
     * @see uk.ac.sussex.gdsc.core.ij.process.LUTHelper.LUTMapper#mapf(float)
     */
    @Override
    public float mapf(float value) {
      return value;
