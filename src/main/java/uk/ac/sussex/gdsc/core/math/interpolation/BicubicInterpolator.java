...
/**
 * Bicubic Interpolator using the Catmull-Rom spline. <p> Taken from
...
public class BicubicInterpolator extends CubicInterpolator {
   ...
   * Gets the interpolated value.
   *
   * @param p the value of the function at x=-1 to x=2 and y=-1 to y=2, length 16 packed as 4 strips
   *        of x values for each y
   * @param x the x (between 0 and 1)
   * @param y the y (between 0 and 1)
   * @return the value
   */
