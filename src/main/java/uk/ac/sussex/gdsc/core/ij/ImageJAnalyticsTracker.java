...
public class ImageJAnalyticsTracker {
  /**
   * Google Analytics (GA) tracking Id. <p> This is the GA property which is used to track all the
   * user activity for the GDSC ImageJ plugins. <p> <b>If you copy this code then please use your
   * own tracking Id!</b>
   */
  private static final String GA_TRACKING_ID = "UA-74666243-1";
  /**
   * Google Analytics (GA) application name. <p> This is the application name for GA. It doesn't
   * really matter what the value is but it is a required field within GA.
   */
  ...
  /**
   * A flag indicating if the anonymise option is available. If set to false then all personal data
   * is anonymised by default. <p> Note: To comply with GDPR any personal data should be anonymised
   */
  ...
  /**
   * Add a custom dimension <p> Note that custom dimensions have to be created for your site before
   * they can be used in analytics reports.
   *
  ...
  /**
   * Check if the anonymise option is available. If set to false then all personal data is
   * anonymised by default and any use of the anonymised flag will throw an IllegalStateException.
   * <p> Note: To comply with GDPR any personal data should be anonymised
   *
  ...
  /**
   * Sets the anonymise option. If set to false then all personal data is anonymised by default and
   * any use of the anonymised flag will throw an IllegalStateException. <p> Note: To comply with
   * GDPR any personal data should be anonymised
   *
   * @param anonymiseOption the new anonymise option
   */
  ...
  /**
   * Set the state of IP anonymization. <p> This can only be set if the anonymise option is
   * available. <p> If data is not anonymised then a secure connection is used (HTTPS) to send the
   * personal data.
   *
   * @param anonymize True if the IP address of the sender will be anonymized
   * @throws IllegalStateException if the option to anonymise data is not configured
   * @deprecated To comply with GDPR any personal data should be anonymised
