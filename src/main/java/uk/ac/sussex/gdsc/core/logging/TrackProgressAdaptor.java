 ...
 *
 * <p>Extend this class to create a <code>TrackProgress</code> and override the methods for the
 * progress events of interest. (If you implement the <code>TrackProgress</code> interface, you have
