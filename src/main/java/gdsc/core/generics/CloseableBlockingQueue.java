 ...
 * <p>
 * This is a copy implementation of java.util.ArrayBlockingQueue. Modifications have been made to allow the queue to be
...
public class CloseableBlockingQueue<E> extends AbstractQueue<E> implements BlockingQueue<E>, java.io.Serializable
{
	...
	/**
	 * Checks if is closed. No additions are possible when the queue is closed. Items can still be removed.
	 *
	...
	/**
	 * Close the queue. No additions are possible when the queue is closed. Items can still be removed.
	 *
	 * @param clear
	 *            Set to true to clear the queue
	 */
	 ...
	 * <p>
	 * If true then additions to the closed queue that normally block when full will
	 * throw an exception. The default is to ignore them.
	 * <p>
	 * If true then removals from the queue that normally block will throw an exception.
	...
	/**
	 * Creates an {@code CloseableBlockingQueue} with the given (fixed)
	 ...
	 *             if this queue is full or closed
	 * @throws NullPointerException
	 ...
	 * Callers should check if the queue is closed after calling this method, i.e. do not
	 * continue generating more items that will be ignored by a closed queue.
	 * <p>
	 * Alternatively use {@link #putAndConfirm(Object)} to know if the element was
	 ...
	 * {@inheritDoc}
	 * <p>
	 * If the queue is closed while waiting then this method will unblock and either return null or throw an exception.
	 * <p>
