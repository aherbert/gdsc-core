...
public class ConcurrentMonoStack<E>
{
	 ...
	 *
	 * @param fair
	 *            if {@code true} then stack accesses for threads blocked
	...
	/**
	 * Checks if is closed. No additions are possible when the stack is closed. Items can still be removed.
	 *
	...
	/**
	 * Checks if is closed. No additions are possible when the stack is closed. Items cannot be removed when the stack
	 * is empty.
	 * <p>
	 * If the stack is closed and empty then synchronisation is avoided on all methods that use the stack since it
	 * cannot change.
	 *
	...
	/**
	 * Close the stack. No additions are possible when the stack is closed. Items can still be removed.
	 *
	 * @param clear
	 *            Set to true to clear the stack
	 */
	 ...
	 * <p>
	 * If true then additions to the closed stack that normally block when full will
	 * throw an exception. The default is to ignore them.
	 * <p>
	 * If true then removals from the stack that normally block will throw an exception.
	 * The default is to return null.
	 * <p>
	 * The exception will be an IllegalStateException.
	 *
	 * @param throwIfClosed
	 *            the new throw if closed
	 */
	...
	/**
	 * Inserts the specified element into the stack waiting if necessary for
	 * space to become available.
	 * <p>
	 * If closed then either ignores the element or throws an exception.
	 * <p>
	 * If the stack is closed while waiting then this method will unblock and ignore the element.
	 * Callers should check the return value to check if further items that will be ignored by a closed stack.
	 *
	 * @param e
	 *            the element to add
	...
	/**
	 * Inserts the specified element into the stack if it is possible to do so
	...
	/**
	 * Retrieves and removes the head of the stack, waiting if
	 * necessary until an element becomes available.
	 * <p>
	 * If the stack is closed while waiting then this method will unblock and either return null or throw an exception.
	 * <p>
	 * Callers should check if the return value is null and appropriately handle a closed empty stack, i.e. do not
	...
	/**
	 * Retrieves and removes the head of the stack, or returns
	...
	/**
	 * Retrieves, but does not remove, the head of the stack, or
	...
	/**
	 * Atomically removes all of the elements from this stack.
