...
public class NonMaximumSuppression implements Cloneable
{
	 ...
	 * @return The maxima indices
	 */
	public int[][] findBlockMaximaCandidatesNxNInternal(float[] data, int maxx, int maxy, int n, int border)
	{
		// Include the actual pixel in the block
		// This makes the block search inclusive: i=0; i<=n; i++
		n++;
	 ...
	 * the block is eliminated. This step is only relevant when neighbour data points have equal values since the
	 ...
	 * @return The maxima indices
	 */
	public int[][] findBlockMaximaCandidatesNxNInternal(int[] data, int maxx, int maxy, int n, int border)
	{
		// Include the actual pixel in the block
		// This makes the block search inclusive: i=0; i<=n; i++
		n++;
