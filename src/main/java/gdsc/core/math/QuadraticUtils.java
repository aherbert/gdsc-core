...
public class QuadraticUtils
{
	 ...
	 *            the data (3x3 matrix)
	 * @param scale
	 *            the scale (this can be set using 1 / [absolute maximum of the data])
	 * @return the determinant
	 */
	 ...
	 * <p>
	 * Solved using Cramer's rule: <a href=
	 ...
	 * <p>
	 * This is the solution to 0 = 2ax + b, i.e. the root of the quadratic gradient.
	 *
	 * @param x1
	 *            the x-coordinate of point 1
	 * @param y1
	 ...
	 *             If there is no quadratic solution (e.g. points are colocated/colinear)
	 */
