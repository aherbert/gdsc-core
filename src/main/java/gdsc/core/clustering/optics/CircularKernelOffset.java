...
public class CircularKernelOffset
{
	...
	public static CircularKernelOffset[] create(int resolution)
	{
		...
		CircularKernelOffset[] offset = new CircularKernelOffset[size];
		...
		double generatingDistanceE = 1;
		double binWidth = generatingDistanceE / resolution;

		double e = generatingDistanceE * generatingDistanceE;
