...
public class RadialSumTest
{
	...
	{
		assertEquals("3", new double[] { 1.0, 8.0, 0 }, RadialSum.radialSum(ones(3), 3));
		assertEquals("4", new double[] { 1.0, 8.0, 7 }, RadialSum.radialSum(ones(4), 4));
		assertEquals("5", new double[] { 1.0, 8.0, 16, 0, 0 }, RadialSum.radialSum(ones(5), 5));
		assertEquals("6", new double[] { 1.0, 8.0, 16, 10, 0 }, RadialSum.radialSum(ones(6), 6));
	}

	@Test
	public void canComputeRadialSum16()
	{
		assertEquals("16", new double[] { 1.0, 8.0, 16, 20, 24, 40, 36, 48, 38, 16, 8, 1 },
				RadialSum.radialSum(ones(16), 16));
	}
	...
	public void canComputeRadialSum512()
	{
		assertEquals("512", new double[] { 1, 8, 16, 20, 24, 40, 36, 48, 56, 56, 68, 64, 80, 92, 88, 96, 96, 116, 120,
				...
				72, 132, 60, 108, 48, 72, 48, 32, 52, 20, 28, 8, 4, 1 }, RadialSum.radialSum(ones(512), 512));
	}

	@Test
	public void canComputeRadialSum8x8()
	{
		assertEquals("8x8", new double[] { 37, 296, 592, 740, 338, 77 }, RadialSum.radialSum(sequence(8), 8));
	}
	...
	public void canComputeRadialSum32x32()
	{
		assertEquals("32x32",
				...
				RadialSum.radialSum(sequence(32), 32));
	}
