...
public class SimpleArrayUtilsTest {
  ...
  private void testMergeOnIndexData(UniformRandomProvider r, int length, final int size,
  ...
  public void testMergeOnRedundantData(UniformRandomProvider r, int length, final int n1,
