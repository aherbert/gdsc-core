...
import uk.ac.sussex.gdsc.test.junit5.*;import uk.ac.sussex.gdsc.test.rng.RngFactory;import uk.ac.sussex.gdsc.core.ags.utils.dataStructures.MaxHeap;
...
public class KdTreeTest {
  ...
  public void canComputeKNNSecondGen(RandomSeed seed) {
    ...
    for (final int n : N) {
      ...
      // Create the KDtree
      final uk.ac.sussex.gdsc.core.ags.utils.dataStructures.trees.secondGenKD.KdTree<Object> tree =
          new uk.ac.sussex.gdsc.core.ags.utils.dataStructures.trees.secondGenKD.KdTree.SqrEuclid2D<>(
              null);
  ...
  public void canComputeKNNThirdGen(RandomSeed seed) {
    ...
    for (final int n : N) {
      ...
      // Create the KDtree
      final uk.ac.sussex.gdsc.core.ags.utils.dataStructures.trees.thirdGenKD.KdTree2D<Object> tree =
          new uk.ac.sussex.gdsc.core.ags.utils.dataStructures.trees.thirdGenKD.KdTree2D<>(2);
      for (final double[] location : data) {
        tree.addPoint(location, null);
      }
  ...
  public void secondGenIsFasterThanThirdGen(RandomSeed seed) {
    ...
    ts.execute(new NNTimingTask("Second2D", data, expected) {
      @Override
      public Object run(Object oData) {
        final uk.ac.sussex.gdsc.core.ags.utils.dataStructures.trees.secondGenKD.KdTree2D<Object> tree =
            new uk.ac.sussex.gdsc.core.ags.utils.dataStructures.trees.secondGenKD.KdTree2D.SqrEuclid2D<>();
        final double[][] data = (double[][]) oData;
        for (final double[] location : data) {
          tree.addPoint(location, null);
        }
    ...
    ts.execute(new NNTimingTask("SecondSimple2D", data, expected) {
      @Override
      public Object run(Object oData) {
        final uk.ac.sussex.gdsc.core.ags.utils.dataStructures.trees.secondGenKD.SimpleKdTree2D tree =
            new uk.ac.sussex.gdsc.core.ags.utils.dataStructures.trees.secondGenKD.SimpleKdTree2D.SqrEuclid2D();
        final double[][] data = (double[][]) oData;
        for (final double[] location : data) {
    ...
    ts.execute(new NNTimingTask("SecondSimpleFloat2D", data, expected, 1e-3) {
      @Override
      public Object run(Object oData) {
        final uk.ac.sussex.gdsc.core.ags.utils.dataStructures.trees.secondGenKD.SimpleFloatKdTree2D tree =
            new uk.ac.sussex.gdsc.core.ags.utils.dataStructures.trees.secondGenKD.SimpleFloatKdTree2D.SqrEuclid2D();
    ...
    ts.execute(new NNTimingTask("Third", data, expected) {
      @Override
      public Object run(Object oData) {
        final uk.ac.sussex.gdsc.core.ags.utils.dataStructures.trees.thirdGenKD.KdTree<Object> tree =
            new uk.ac.sussex.gdsc.core.ags.utils.dataStructures.trees.thirdGenKD.KdTreeND<>(2);
        final double[][] data = (double[][]) oData;
        for (final double[] location : data) {
          tree.addPoint(location, null);
        }
    ...
    ts.execute(new NNTimingTask("Third2D", data, expected) {
      ...
      public Object run(Object oData) {
        final uk.ac.sussex.gdsc.core.ags.utils.dataStructures.trees.thirdGenKD.KdTree<Object> tree =
            new uk.ac.sussex.gdsc.core.ags.utils.dataStructures.trees.thirdGenKD.KdTree2D<>();
        final double[][] data = (double[][]) oData;
        for (final double[] location : data) {
          tree.addPoint(location, null);
        }
