...
public class ScaledIndexedCubicSplinePositionTest {
    ...
    public void testConstructor() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            @SuppressWarnings("unused")
            final ScaledIndexedCubicSplinePosition p = new ScaledIndexedCubicSplinePosition(index, x, -1e-6);
        });
    }
    ...
    public void testProperties() {
        ...
        for (int i = 1; i <= 5; i++) {
            ...
            final ScaledIndexedCubicSplinePosition p = new ScaledIndexedCubicSplinePosition(index, x, scale);
