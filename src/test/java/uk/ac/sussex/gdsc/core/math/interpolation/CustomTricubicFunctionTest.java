...
public class CustomTricubicFunctionTest {
    ...
    public void canAccessCoefficients() {
        ...
        final FloatCustomTricubicFunction ff = (FloatCustomTricubicFunction) CustomTricubicFunction.create(fa.clone());
        final DoubleCustomTricubicFunction df = (DoubleCustomTricubicFunction) CustomTricubicFunction
                .create(da.clone());
        for (int i = 0; i < fa.length; i++) {
