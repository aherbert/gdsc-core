    ...
    public void densityWithGridFasterThanDensityTriangle(RandomSeed seed)
    {
        ...
        for (final int n : N)
        {
            ...
            for (final float radius : radii)
            {
                ...
                final Supplier<String> msg = FunctionUtils.getSupplier("Grid vs Triangle. N=%d, R=%f : %fx faster", n, radius,
                        (double) t1 / t2);
                logger.info(msg);
    ...
    public void densityWithGridFasterThanDensity(RandomSeed seed)
    {
        ...
        for (final int n : N)
        {
            ...
            for (final float radius : radii)
            {
                ...
                final Supplier<String> msg = FunctionUtils.getSupplier("Grid vs Standard. N=%d, R=%f : %fx faster", n, radius,
                        (double) t1 / t2);
                logger.info(msg);
                Assertions.assertTrue(t2 < t1, msg);
            }
    ...
    public void sumWithGridFasterThanSum(RandomSeed seed)
    {
        ...
        for (final int n : N)
        {
            ...
            for (final float radius : radii)
            {
                ...
                final Supplier<String> msg = FunctionUtils.getSupplier("Sum Grid vs Standard. N=%d, R=%f : %fx faster", n, radius,
                        (double) t1 / t2);
                logger.info(msg);
                Assertions.assertTrue(t2 < t1, msg);
            }
