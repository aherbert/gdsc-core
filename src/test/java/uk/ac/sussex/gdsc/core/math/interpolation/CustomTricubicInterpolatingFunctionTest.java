...
public class CustomTricubicInterpolatingFunctionTest {
    ...
    public void testComputeCoefficients() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            double[] e = CustomTricubicInterpolatingFunction.computeCoefficients(beta);
            double[] o = CustomTricubicInterpolatingFunction.computeCoefficientsInline(beta);
            // Exactly the same
            Assertions.assertArrayEquals(e, o);
            double[] o2 = CustomTricubicInterpolatingFunction.computeCoefficientsInlineCollectTerms(beta);
            // Almost the same
    ...
    public void testCreate() {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            CustomTricubicFunction fun1 = CustomTricubicInterpolatingFunction.create(f, dFdX, dFdY, dFdZ, d2FdXdY,
                    d2FdXdZ, d2FdYdZ, d3FdXdYdZ);
            double[] e = CustomTricubicInterpolatingFunction.computeCoefficientsInlineCollectTerms(beta);
            ...
            CustomTricubicFunction fun2 = CustomTricubicInterpolatingFunction.create(xscale, yscale, zscale, f, dFdX,
                    dFdY, dFdZ, d2FdXdY, d2FdXdZ, d2FdYdZ, d3FdXdYdZ);
    ...
    public void testConstructorThrows() {
        ...
        Assertions.assertNotNull(new CustomTricubicInterpolatingFunction(x, y, z, f, dFdX, dFdY, dFdZ, d2FdXdY, d2FdXdZ,
        ...
        Assertions.assertThrows(NoDataException.class, () -> {
            @SuppressWarnings("unused")
            CustomTricubicInterpolatingFunction f1 = new CustomTricubicInterpolatingFunction(x1, y, z, f, dFdX, dFdY,
                    dFdZ, d2FdXdY, d2FdXdZ, d2FdYdZ, d3FdXdYdZ, progress, executorService, taskSize, singlePrecision);
        });
        Assertions.assertThrows(NoDataException.class, () -> {
            @SuppressWarnings("unused")
            CustomTricubicInterpolatingFunction f1 = new CustomTricubicInterpolatingFunction(x, x1, z, f, dFdX, dFdY,
                    dFdZ, d2FdXdY, d2FdXdZ, d2FdYdZ, d3FdXdYdZ, progress, executorService, taskSize, singlePrecision);
        });
        Assertions.assertThrows(NoDataException.class, () -> {
            @SuppressWarnings("unused")
            CustomTricubicInterpolatingFunction f1 = new CustomTricubicInterpolatingFunction(x, y, x1, f, dFdX, dFdY,
                    dFdZ, d2FdXdY, d2FdXdZ, d2FdYdZ, d3FdXdYdZ, progress, executorService, taskSize, singlePrecision);
        });
        Assertions.assertThrows(DimensionMismatchException.class, () -> {
            @SuppressWarnings("unused")
            CustomTricubicInterpolatingFunction f1 = new CustomTricubicInterpolatingFunction(x3, y, z, f, dFdX, dFdY,
                    dFdZ, d2FdXdY, d2FdXdZ, d2FdYdZ, d3FdXdYdZ, progress, executorService, taskSize, singlePrecision);
        });
        Assertions.assertThrows(DimensionMismatchException.class, () -> {
            @SuppressWarnings("unused")
            CustomTricubicInterpolatingFunction f1 = new CustomTricubicInterpolatingFunction(x, x3, z, f, dFdX, dFdY,
                    dFdZ, d2FdXdY, d2FdXdZ, d2FdYdZ, d3FdXdYdZ, progress, executorService, taskSize, singlePrecision);
        });
        Assertions.assertThrows(DimensionMismatchException.class, () -> {
            @SuppressWarnings("unused")
            CustomTricubicInterpolatingFunction f1 = new CustomTricubicInterpolatingFunction(x, y, x3, f, dFdX, dFdY,
                    dFdZ, d2FdXdY, d2FdXdZ, d2FdYdZ, d3FdXdYdZ, progress, executorService, taskSize, singlePrecision);
        });
        Assertions.assertThrows(NonMonotonicSequenceException.class, () -> {
            @SuppressWarnings("unused")
            CustomTricubicInterpolatingFunction f1 = new CustomTricubicInterpolatingFunction(x_2, y, z, f, dFdX, dFdY,
                    dFdZ, d2FdXdY, d2FdXdZ, d2FdYdZ, d3FdXdYdZ, progress, executorService, taskSize, singlePrecision);
        });
        Assertions.assertThrows(NonMonotonicSequenceException.class, () -> {
            @SuppressWarnings("unused")
            CustomTricubicInterpolatingFunction f1 = new CustomTricubicInterpolatingFunction(x, x_2, z, f, dFdX, dFdY,
                    dFdZ, d2FdXdY, d2FdXdZ, d2FdYdZ, d3FdXdYdZ, progress, executorService, taskSize, singlePrecision);
        });
        Assertions.assertThrows(NonMonotonicSequenceException.class, () -> {
            @SuppressWarnings("unused")
            CustomTricubicInterpolatingFunction f1 = new CustomTricubicInterpolatingFunction(x, y, x_2, f, dFdX, dFdY,
                    dFdZ, d2FdXdY, d2FdXdZ, d2FdYdZ, d3FdXdYdZ, progress, executorService, taskSize, singlePrecision);
        });

        CustomTricubicFunction[][][] splines = new CustomTricubicFunction[1][1][1];
        ...
        Assertions.assertThrows(NoDataException.class, () -> {
            @SuppressWarnings("unused")
            CustomTricubicInterpolatingFunction f1 = new CustomTricubicInterpolatingFunction(x1, y, z, splines);
        });
        Assertions.assertThrows(NoDataException.class, () -> {
            @SuppressWarnings("unused")
            CustomTricubicInterpolatingFunction f1 = new CustomTricubicInterpolatingFunction(x, x1, z, splines);
        });
        Assertions.assertThrows(NoDataException.class, () -> {
            @SuppressWarnings("unused")
            CustomTricubicInterpolatingFunction f1 = new CustomTricubicInterpolatingFunction(x, y, x1, splines);
        });
        Assertions.assertThrows(DimensionMismatchException.class, () -> {
            @SuppressWarnings("unused")
            CustomTricubicInterpolatingFunction f1 = new CustomTricubicInterpolatingFunction(x3, y, z, splines);
        });
        Assertions.assertThrows(DimensionMismatchException.class, () -> {
            @SuppressWarnings("unused")
            CustomTricubicInterpolatingFunction f1 = new CustomTricubicInterpolatingFunction(x, x3, z, splines);
        });
        Assertions.assertThrows(DimensionMismatchException.class, () -> {
            @SuppressWarnings("unused")
            CustomTricubicInterpolatingFunction f1 = new CustomTricubicInterpolatingFunction(x, y, x3, splines);
        });
        Assertions.assertThrows(NonMonotonicSequenceException.class, () -> {
            @SuppressWarnings("unused")
            CustomTricubicInterpolatingFunction f1 = new CustomTricubicInterpolatingFunction(x_2, y, z, splines);
        });
        Assertions.assertThrows(NonMonotonicSequenceException.class, () -> {
            @SuppressWarnings("unused")
            CustomTricubicInterpolatingFunction f1 = new CustomTricubicInterpolatingFunction(x, x_2, z, splines);
        });
        Assertions.assertThrows(NonMonotonicSequenceException.class, () -> {
            @SuppressWarnings("unused")
            CustomTricubicInterpolatingFunction f1 = new CustomTricubicInterpolatingFunction(x, y, x_2, splines);
        });
    }
    ...
    public void testIsUniformIsInteger() {
        ...
        CustomTricubicFunction[][][] splines = new CustomTricubicFunction[2][2][2];
        double[] a = new double[64];
        for (int z = 0; z < 2; z++) {
            for (int y = 0; y < 2; y++) {
                for (int x = 0; x < 2; x++) {
        ...
        testIsUniformIsInteger(new CustomTricubicInterpolatingFunction(tt, tt, tt, splines), true, true);
        testIsUniformIsInteger(new CustomTricubicInterpolatingFunction(tf, tt, tt, splines), true, false);
        testIsUniformIsInteger(new CustomTricubicInterpolatingFunction(tt, tf, tt, splines), true, false);
        testIsUniformIsInteger(new CustomTricubicInterpolatingFunction(tt, tt, tf, splines), true, false);
        testIsUniformIsInteger(new CustomTricubicInterpolatingFunction(ff, tt, tt, splines), false, false);
        testIsUniformIsInteger(new CustomTricubicInterpolatingFunction(tt, ff, tt, splines), false, false);
        testIsUniformIsInteger(new CustomTricubicInterpolatingFunction(tt, tt, ff, splines), false, false);

        CustomTricubicInterpolatingFunction f = new CustomTricubicInterpolatingFunction(tt, tt, tt, splines);
        double[] e = f.getScale();
        double[] o = f.getScale(); // This is a clone
    ...
    private static void testIsUniformIsInteger(CustomTricubicInterpolatingFunction f, boolean isUniform,
            boolean isInteger) {
    ...
    public void testCanConvertPrecision() {
        ...
        double[] a = new double[64];
        splines[0][0][0] = CustomTricubicFunction.create(a);
        CustomTricubicInterpolatingFunction f = new CustomTricubicInterpolatingFunction(x, x, x, splines);
